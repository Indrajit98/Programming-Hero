        ...
        children:[
            {
               ...
               loader:() => fetch('https://dragon-news-server-bice.vercel.app/news')
               
            },
            {
               path:'/category/:id',element:<Category></Category>,
               loader:({params}) => fetch(`https://dragon-news-server-bice.vercel.app/category/${params.id}`)
            },
            {
               path:'/news/:id',element:<PrivateRoute><News></News></PrivateRoute>,
               loader:({params}) => fetch(`https://dragon-news-server-bice.vercel.app/news/${params.id}`)
            },
            {
               path:'/',element:<Home></Home> 
            },
