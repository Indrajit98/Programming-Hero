        ...
        <div className='md:w-1/4 p-3 mx-auto'>
            ...
            <form onSubmit={handleSubmit(handleSignUp)}>
                <div className='form-control w-full '>
                    ...
                    <input type='text' {...register("name", { required: 'Name is required *' })} placeholder="Your Email" className='input input-bordered w-full' />  
                ...
                <input className='btn btn-primary bg-gradient-to-r from-primary to-secondary text-white w-full mt-4' type="submit" />
            </form>
            <p className='pt-4'>Already have an account <Link to='/login' className='text-primary'>Login</Link> </p> 
